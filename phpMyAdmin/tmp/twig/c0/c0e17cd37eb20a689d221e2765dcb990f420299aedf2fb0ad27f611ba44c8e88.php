...
($context["allow_user_drop_database"] ?? null)));
    ...
    {
        return new Twig_Source("", "server/databases/databases_header.twig", "/home/ec2-user/environment/lsapp/phpMyAdmin/templates/server/databases/databases_header.twig");
    }
}
